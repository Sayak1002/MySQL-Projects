...
-- ADDING FOREIGN KEYS TO CREATE RELATIONSHIPS BETWEEN THE TABLES
ALTER TABLE issued_status ADD CONSTRAINT fk_member
FOREIGN KEY (issued_member_id) REFERENCES members(member_id) ON DELETE CASCADE;

ALTER TABLE issued_status ADD CONSTRAINT fk_books
FOREIGN KEY(issued_book_isbn) REFERENCES books(isbn) ON DELETE SET NULL;

ALTER TABLE issued_status ADD CONSTRAINT fk_emp
FOREIGN KEY(issued_emp_id) REFERENCES employee(emp_id) ON DELETE SET NULL;

ALTER TABLE employee ADD CONSTRAINT fk_branch
FOREIGN KEY(branch_id) REFERENCES branch(branch_id)  ON DELETE SET NULL;

ALTER TABLE return_status ADD CONSTRAINT fk_issed_status
...
-- The returned table data was imported using the Table data import wizard 
